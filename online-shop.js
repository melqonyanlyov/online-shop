...
const globalData = Object.freeze({
    ...
    slider: [
        '../online-shop/sliderImg/1.jpg',
        '../online-shop/sliderImg/2.jpg',
        '../online-shop/sliderImg/3.jpg',
        '../online-shop/sliderImg/4.jpg',
        '../online-shop/sliderImg/5.jpg',
        '../online-shop/sliderImg/1.jpg',
    ],

    productImage: [
        [
            '../online-shop/ProductImage/1.jpg',
            '../online-shop/ProductImage/2.jpg',
            '../online-shop/ProductImage/3.jpg',
        ],
        [
            '../online-shop/ProductImage/4.jpg',
            '../online-shop/ProductImage/5.jpg',
            '../online-shop/ProductImage/6.jpg',
        ],
        [
            '../online-shop/ProductImage/7.jpg',
            '../online-shop/ProductImage/8.jpg',
            '../online-shop/ProductImage/9.jpg',
        ],
        [
            '../online-shop/ProductImage/10.jpg',
            '../online-shop/ProductImage/11.jpg',
            '../online-shop/ProductImage/12.jpg',
        ],
        [
            '../online-shop/ProductImage/13.jpg',
            '../online-shop/ProductImage/14.jpg',
            '../online-shop/ProductImage/15.jpg',
        ],
        [
            '../online-shop/ProductImage/16.jpg',
            '../online-shop/ProductImage/17.jpg',
            '../online-shop/ProductImage/18.jpg',
        ],
        [
            '../online-shop/ProductImage/19.jpg',
            '../online-shop/ProductImage/20.jpg',
            '../online-shop/ProductImage/21.jpg',
        ],
        [
            '../online-shop/ProductImage/22.jpg',
            '../online-shop/ProductImage/23.jpg',
            '../online-shop/ProductImage/24.jpg',
        ],
        [
            '../online-shop/ProductImage/25.jpg',
            '../online-shop/ProductImage/26.jpg',
            '../online-shop/ProductImage/27.jpg',
        ],
    ],
    flafFace: [
        'url("../online-shop/Project Image/USA.jpg") no-repeat center / cover',
...
header.append(logo);
logo.setAttribute('href', 'online-shop.html');
logo.setAttribute('target', '_blank');
const logoImg = c('img');
logo.append(logoImg);
logoImg.setAttribute('alt', 'Img');
logoImg.setAttribute('src', '../online-shop/Project Image/logo.jpg');
...
globalData.language[globalData.data.langIndex].searchList.forEach((item, index) => {
    ...
    for(let i = 0; i < 2; i++) {
        ...
        quantBtn.style = screenDigit.getAttribute('style'); 
...
setInterval(() => {
    [...cartLineBlock.children].forEach((item, index) => { 
